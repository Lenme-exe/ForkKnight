    ...
    internal class SolidObjectCollisionResponder : ICollisionResponder
    {
        public void RespondToCollision(GameObject gameObject, Rectangle collisionRectangle)
        {
            ...
            if (intersection.Height < intersection.Width)
            {
                ...
                {
                    gameObject.Position = new Vector2(gameObject.Position.X, collisionRectangle.Top - gameObject.Hitbox.Height); //kanker
            ...
            else if (intersection.Width < intersection.Height)
            {
                ...
                {
                    gameObject.Position = new Vector2(collisionRectangle.Left - gameObject.Hitbox.Width, gameObject.Position.Y); //kanker
